...
*)
	...
	let val _ = printSpace space
	    val _ = print ("case " ^ cond ^ "\n")
	    val _ = printSpace space
	    val _ = print (" of In1 " ^ thenarg ^ " =>\n")
	...
	in ()
      ...
      | LetPrim{name, opr=PrimOp.Print, args=[s], body} =>
	let val _ = printSpace space
            val _ = print ("let val " ^ name ^ " = print "^s^"\n    in\n")
            val _ = pp0 (body, space +1)
            val _ = print "\n"
            val _ = printSpace space
            val _ = print "end\n"
      ...
      | LetPrim {name, opr=option, args=[x1, x2], body} =>
        let val _ = printSpace space
...
*)
      ...
      | LetPrim {name, opr=PrimOp.Int2String, args=[s], body} =>
        let val _ = printSpace space
            val _ = print ("let val " ^ name ^ " = Int.toString "^s^"\n in\n")
            val _ = pp0 (body, space +1)
            val _ = print "\n"
            val _ = printSpace space
            val _ = print "end\n"
